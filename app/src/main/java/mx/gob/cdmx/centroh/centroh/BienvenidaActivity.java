...
//    private TransparentProgressDialog pd;
    ...
    private void Verifypermissions()
    {
        ...
        if(ContextCompat.checkSelfPermission(this.getApplicationContext(),
                ...
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[7])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[8])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[9])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[10])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[11])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[12])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[13])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[14])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[15])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[16])==PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(this.getApplicationContext(),
                permissions[16])==PackageManager.PERMISSION_GRANTED)
        {
            return;
        ...
        {
            ActivityCompat.requestPermissions(BienvenidaActivity.this,permissions,REQUEST_CODE);
        }
...
//        Verifypermissions();
        ...
        if(ids.length==0){
            ...
            Log.i(TAG,"cqs -->> sacaMaximo: "+sacaMaximo());
            ...
            if (!verificaConexion(this)) {  //SI NO ES
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (dato.equals("0")) {
                            showAlertDialog("AVISO", "No hay datos de ubicacion", true);
                        } else {
...
//		}
    ...
    public void requestPinAppWidget(){
        ...
        if (appWidgetManager.isRequestPinAppWidgetSupported()) {
            ...
            Intent pinnedWidgetCallbackIntent = new Intent(this, mx.gob.cdmx.centroh.service.GPSWidgetProvider.class);
    ...
    private String sacaMaximo() {
        ...
        usdbh3 = new UsuariosSQLiteHelper3(this);
        db3 = usdbh3.getReadableDatabase();
        String selectQuery = "SELECT count(*) FROM ubicacion where " +"datetime(substr(fecha,0,5)||'-'||substr(fecha,5,2) ||'-'||substr(fecha,7,2)||' '|| hora)  >= datetime('now','localtime','-1 hour')  order by hora";
