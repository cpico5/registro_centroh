...
import static mx.gob.cdmx.registro_centroh.UsuariosSQLiteHelper2.TablaUsuarios.TABLA_USUARIOS;
...
//        db.execSQL(DaoManager.generateDropIfExistsQueryString(candidatos_cdmx.class));
        onCreate(db);
    }
