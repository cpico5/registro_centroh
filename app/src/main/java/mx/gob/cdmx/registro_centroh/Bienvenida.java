...
import mx.gob.cdmx.registro_centroh.model.Aplicacion;
import mx.gob.cdmx.registro_centroh.model.candidatos_cdmx;
import mx.gob.cdmx.registro_centroh.service.AndroidLocationServices;
import mx.gob.cdmx.registro_centroh.service.GPSWidgetProvider;

import static mx.gob.cdmx.registro_centroh.Nombre.ALCALDIA;
import static mx.gob.cdmx.registro_centroh.Nombre.customURL;
import static mx.gob.cdmx.registro_centroh.Nombre.customURLcatalogos;
import static mx.gob.cdmx.registro_centroh.model.Nombre.APLICACION;
...
//                showProgress(false);
    ...
    public void pasaEncuesta() {
        Intent intent = new Intent(Bienvenida.this, null);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        Bundle bundle = new Bundle();
        bundle.putString("Nombre", sacaUsr());
        intent.putExtras(bundle);
...
//                    showProgress(false);
    ...
    public void requestPinAppWidget() {
        ...
        ComponentName myProvider =
                new ComponentName(this, mx.gob.cdmx.registro_centroh.service.GPSWidgetProvider.class);

        if (appWidgetManager.isRequestPinAppWidgetSupported()) {
            // Create the PendingIntent object only if your app needs to be notified
            // that the user allowed the widget to be pinned. Note that, if the pinning
            // operation fails, your app isn't notified.
            Intent pinnedWidgetCallbackIntent = new Intent(this, mx.gob.cdmx.registro_centroh.service.GPSWidgetProvider.class);
